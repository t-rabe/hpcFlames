...
//    string fileNum = to_string(fileNumInt);
    ...
    string fileName = "../output/testDriverMT" + fileNum + ".bin";
    ...
    // Pixel *floatColorMat = new Pixel[num6];
    Funcs funcs;
    ...
    MakeMatrixMT *makematrix = new MakeMatrixMT(num1,num3,num5,applyfuncs->getData2(),includingAlpha);
    delete applyfuncs;

    cout << "Normalizing matrix..." << endl;
    Pixel *floatColorMat = makematrix->getMatrixNormAsFloat3();
    delete makematrix;
