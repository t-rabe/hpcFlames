#ifndef MAKEMATRIXAVG
#define MAKEMATRIXAVG
...
class MakeMatrixAvg{
	private:
        ...
        void compileData();
        void compileDataAveraging();
	public:
		MakeMatrixAvg(int numFuncs, int numSamples, int sideLen, vector<vector<float>> data, bool includeAlph);
		MakeMatrixAvg() = default; // pass in default constructor
		~MakeMatrixAvg() = default;
        void normAsFloat3();
        void noNorm();
		Pixel* getMatrix();
