...
class ApplyFuncs{
	private:
		...
		void assignSamples(vector<vector<int>> indices, vecFuncs a[], Funcs funcs); // assigns each sample to a thread
	public:
		ApplyFuncs(vector<vector<int>> indices, vecFuncs a[], Funcs funcs);
